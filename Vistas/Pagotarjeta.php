                  ...
                  <form class="mx-1 mx-md-4" action="add.php" method="post">              
                    ...
                    <i class="bi bi-person"></i>
                          <div class="form-outline flex-fill mb-0">
                            <label class="form-label" for="form3Example1c"><i class="bi bi-shop"></i> Nombre</label>
                    ...
                    <i class="bi bi-postcard"></i>
                          <div class="form-outline flex-fill mb-0">
                            <label class="form-label" for="form3Example1c"><i class="bi bi-shop"></i> Tarjeta</label>
                            <input type="text" id="form3Example1c" class="form-control form-control-lg py-2" name="NombreEmpresa" autocomplete="off" placeholder="Ingresa el nombre de la empresa" style="border-radius:25px ;" />
                          </div>
                    </div>
                    <!-- ANO -->
                    ...
                    <i class="bi bi-calendar"></i>
                          <div class="form-outline flex-fill mb-0">
                            <label class="form-label" for="form3Example1c"><i class="bi bi-shop"></i> Ano</label>
                            <input type="text" id="form3Example1c" class="form-control form-control-lg py-2" name="NombreEmpresa" autocomplete="off" placeholder="Ingresa el nombre de la empresa" style="border-radius:25px ;" />
                          </div>
                    </div>
                    <!-- CVV -->
                    ...
                    <i class="bi bi-postcard"></i>
                          <div class="form-outline flex-fill mb-0">
                            <label class="form-label" for="form3Example1c"><i class="bi bi-shop"></i> CVV</label>
                            <input type="text" id="form3Example1c" class="form-control form-control-lg py-2" name="NombreEmpresa" autocomplete="off" placeholder="Ingresa el nombre de la empresa" style="border-radius:25px ;" />
                          </div>
                    </div>          
                    <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                      <!--<input type="submit" value="PAGAR" name="Pago" class="btn btn-primary btn-lg text-light my-2 py-2" style="width:100% ; border-radius: 30px; font-weight:600;" style="border-radius:25px ;" onclick="pagar()" />-->
                      <button type="button" class="btn btn-primary btn-lg btn-block" onclick="pagar()">Pagar</button>
                    </div>

                  </form>
                  <p align="center">Regresar a <a href="Login_empresas.php" class="text-primary" style="font-weight:600; text-decoration:none;"> INICIO</a></p>
                </div>
                <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">

                  <img src="../Imagenes/tarjeta.png" class="img-fluid" alt="Sample image" height="300px" width="500px">
