...
<a class="navbar-brand" href="Index.php">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="vistas/Alojamiento.php">Alojamiento</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="vistas/Servicios.php">Servicios</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="vistas/Otros.php">Otros</a>
        </li>
      </ul>
      <form class="d-flex">
  ...
  <div class="container">
    ...
    <div class="site">
      <h1 style="text-align:center">Las mejores ofertas</h1>
      <h2 style="text-align:center">En CuponeraSV</h2>
      <img src="Imagenes/Logoindex.png"  alt="Sample image" height="50%" width="90%">
    </div>
    </div>
    </div>
  </div>
